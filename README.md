...
#### It seems this colab is not working due to the updated google colab again, I don't plan to fix it. I have implemented stitchdiffusion to generate 360-degree panoramas through text prompts based on diffusers.
